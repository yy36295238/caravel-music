...
// 初始标记直接关闭歌词并释放右栏，避免启动闪现或程序聚焦到歌词按钮。
function mount() {
  $('#app').innerHTML = `<div class="layout">
    ...
    <main class="workspace">
      ...
      <div class="content lyrics-hidden"><section class="library" aria-label="音乐库">
